...
contract DEVSNFTs is ERC_721_token {
        ...
        returns (uint256 TokenIDminted)
    {
        ...
        if (currentState == State.PreSale) {
            ...
            require(
                RewardingTokenAddr.balanceOf(msg.sender) >=
                    50 * 10**RewardingTokenAddr.decimals(),
                "You require 50 staking tokens to Participate in PRE SALE"
            );
            require(
                RewardingTokenAddr.transferFrom(
                    msg.sender,
                    address(this),
                    50 * 10**RewardingTokenAddr.decimals()
                ),
            ...
            require(
                RewardingTokenAddr.balanceOf(msg.sender) >=
                    100 * 10**RewardingTokenAddr.decimals(),
        ...
        returns (uint256 TokenID1, uint256 TokenID2)
    {
        ...
        if (currentState == State.PreSale) {
            ...
            require(
                RewardingTokenAddr.balanceOf(msg.sender) >=
                    200 * 10**RewardingTokenAddr.decimals(),
